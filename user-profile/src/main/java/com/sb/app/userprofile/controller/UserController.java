package com.sb.app.userprofile.controller;
...
import com.sb.app.userprofile.service.UserService;
...
public class UserController {
	...
	@DeleteMapping(path="/permanentdelete/{id}")
	public boolean permanentDelete(@PathVariable("id") Long id){
